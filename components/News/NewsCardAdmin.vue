<template>
  ...
  >
    <!-- WRAPPER GAMBAR -->
    <div v-if="thumbnail" class="w-full h-[40dvh] flex items-center justify-center bg-gray-100 dark:border-2 dark:rounded-lg dark:border-b-0 dark:border-KKNWhite  dark:bg-gray-800 overflow-hidden">
      <img
        v-if="thumbnail"
        :src="thumbnail"
        :alt="title"
    ...
    <!-- KONTEN & TOMBOL -->
    <div class="p-4 flex flex-col flex-1 bg-KKNWhite dark:border-KKNWhite dark:border-2 dark:rounded-lg  dark:border-solid dark:bg-KKNBlack">
